<template>
  <div class="tareas">
    ...
    <div class="container">
        {% for tarea in tareas %}
            {% if tarea.completo == false %}
                <div class="box" id="{{tarea.id_tarea}}">
                    <div class="details">
                        <h2>Tarea: {{tarea.titulo}}</h2> 
                        <p>Descripción: {{tarea.descripcion}}</p>
                        <p>{{tarea.empleado}}</p>
                    </div>
                    <input id="{{tarea.id_tarea}}" class="completo" type="checkbox" autocomplete="off"/>
                </div>
            {% endif %}
        {% endfor %}
    </div>
...
.popup-form, .popup-form-task, .popup-form-edit
{
  width: 100%;
  height: 100%;
...
.popup-form.active, .popup-form-task.active, .popup-form-edit.active
{
  opacity: 1;
  z-index: 0;
  transform: scale(1);
